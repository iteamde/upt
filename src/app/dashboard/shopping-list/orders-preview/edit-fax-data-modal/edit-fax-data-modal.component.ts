...
@Component({
  selector: 'edit-fax-data-modal',
  templateUrl: './edit-fax-data-modal.component.html',
...
export class EditFaxDataModal implements OnInit, AfterViewInit, ModalComponent<EditEmailDataModalContext> {
  ...
  constructor(
    ...
    this.faxSubject = 'Purchase order #' + this.context.po_number;
    this.fileActions();
  ...
  sendPO() {
    this.orderService.sendOrderRequestFinal(this.context.order_id, {
      ...
      subject: this.faxSubject,
      to_name: this.nameTo,
      from_name: this.nameFrom,
