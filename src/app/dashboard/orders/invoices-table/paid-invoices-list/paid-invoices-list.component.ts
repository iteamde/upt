...
import { PaidInvoicesListService } from '../services/paid-invoices-list.service';
...
@Component({
  selector: 'app-paid-invoices-list',
  templateUrl: './paid-invoices-list.component.html',
  styleUrls: ['./paid-invoices-list.component.scss'],
})
@DestroySubscribers()
export class PaidInvoicesListComponent implements OnInit, OnDestroy {
  public subscribers: any = {};

  public listName: string = OrderListType.paid;
  ...
  constructor(
    ...
    public paidInvoicesListService: PaidInvoicesListService,
  ...
  ngOnInit() {
    this.invoices$ = this.paidInvoicesListService.collection$;
  };

  addSubscribers() {
    this.subscribers.getAllCollectionSubscription = this.paidInvoicesListService.getCollection()
    .subscribe();
  };
